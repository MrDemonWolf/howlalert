...
| **Push notification content (usage summary)** | To show your remaining window on your iPhone/Watch | Relayed through our server + Apple APNs; held only transiently in cache | Not stored after delivery (cache auto-expires in minutes) |
